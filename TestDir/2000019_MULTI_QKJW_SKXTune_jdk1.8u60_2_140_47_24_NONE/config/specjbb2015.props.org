...
specjbb.forkjoin.workers.Tier1=54
specjbb.forkjoin.workers.Tier2=34
specjbb.forkjoin.workers.Tier3=10
...
specjbb.comm.connect.worker.pool.min=32
specjbb.mapreducer.pool.size=18


#specjbb.comm.messageOnTier=2
#specjbb.comm.connect.connpool.size = 420
#specjbb.comm.connect.pool.max = 480
#specjbb.customerDriver.threads = 128
#specjbb.customerDriver.threads.saturate = 270
